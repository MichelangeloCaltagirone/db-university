...
-- Selezionare tutti i docenti che insegnano nel Dipartimento di Matematica (risultato - 54)
SELECT DISTINCT `teachers`.`name` AS `Nome`, `teachers`.`surname` AS `cognome`
FROM `teachers`
